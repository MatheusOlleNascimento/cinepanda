...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  void initState() {
    super.initState();
    final movieId = Provider.of<ComponentsProvider>(context, listen: false).selectedMovieId;
    isFavoriteFuture = context.read<DatabaseProvider>().checkFavorite(movieId);
  }
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return FutureBuilder<bool>(
              ...
              builder: (context, isFavoriteSnapshot) {
                if (isFavoriteSnapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CircularProgressIndicator());
                }

                final isFavorite = isFavoriteSnapshot.data ?? false;
                                    ...
                                    builder: (context, moviesProvider, child) {
                                      return GestureDetector(
                                        onTap: () async {
                                          ...
                                          setState(() {
                                            isFavoriteFuture = moviesProvider.checkFavorite(movie.id);
                                          });
                                        },
                                        child: Card(
